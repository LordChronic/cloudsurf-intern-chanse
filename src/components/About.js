...
function About() {
  ...
  return (
    <div style={styles.container} className={`animate__animated ${headerInView ? 'animate__fadeIn' : ''}`}>
      <h1 style={styles.header} ref={headerRef}>
        About Me
      </h1>
      <p style={styles.paragraph}>
        Hi there! I'm Chanse Shaw, an HVAC Service Technician based in Las Vegas,
        ...
        striving for my Bachelor's of Applied Sciences with a focus in Cyber
      ...
      <div style={styles.section}>
        <div>
          <h2 ref={subHeaderRef} className={`animate__animated ${subHeaderInView ? 'animate__fadeIn' : ''}`} style={styles.subHeader}>
            My Skills
          </h2>
        ...
        <div>
          <h2 className={`animate__animated ${subHeaderInView ? 'animate__fadeIn' : ''}`} style={styles.subHeader}>
            Experience
          </h2>
          <ul style={styles.list}>
            <li style={styles.listItem}>HVAC Service Technician: 5 1/5 years</li>
            <li style={styles.listItem}>Natural Gas Technician</li>
            <li style={styles.listItem}>Less than a month of FreeCodeCamp</li>
            <li style={styles.listItem}>Certified Loverboy?</li>
            <li style={styles.listItem}>Goon King: 27 years</li>
          </ul>
        </div>
      </div>
    </div>
